...
By default the browser runs headless.  Use ``--headless`` to watch every
Playwright step in a real browser window — handy when troubleshooting
ennexOS login issues.

.. code-block:: console

    python zonnebrand.py --headless
...
.. code-block:: console
    ...
    python zonnebrand.py --provider anwb --headless --mail your@email.com
